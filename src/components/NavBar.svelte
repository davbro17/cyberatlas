<script>
  ...
  import { faArrowDown, faArrowUp, faBars, faEdit, faDatabase, faBriefcase, faBook, faSlidersH } from '@fortawesome/free-solid-svg-icons';
...
<nav class="navzone">
    <ul class="navzone-nav">
      ...
      {#each links as link}
        <li class="nav-item">
          <a href="#apps" class="nav-link" on:click={() => changeView(link.component)}>
            <Icon icon={link.icon} class="linkIcon"/>
            <span class="link-text">{link.title}</span>
          </a>
        </li>
      {/each}
      <li class="nav-item" id="themeButton" on:click={toggleTheme}>
